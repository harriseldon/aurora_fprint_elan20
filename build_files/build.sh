...
echo "Enabling copr johnc456/libfprint-elanmoc2"
#dnf5 -y copr enable  ntibbitts/Libfprint-Elanmoc2 
dnf -y copr enable johnc456/libfprint-elanmoc2 fedora-43-x86_64
...
dnf -y copr disable johnc456/libfprint-elanmoc2
